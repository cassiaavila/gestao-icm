...
import { SweetAlertService, AlertIcon } from '../../shared/service/sweet-alert.service';
  ...
  filterHomes(){
    ...
    if(this.filterName !== undefined && this.filterName != null && this.filterName != ''){
      for(const model of this.listTotal){
        ...
        resultSenderSocialName = senderSocialNameLowerCase.includes(this.filterName.toLowerCase());
        ...
        resultSenderBusinesName = senderBussnessNameLowerCase.includes(this.filterName.toLowerCase());
        ...
        resultRecipientSocialName = recipientSocialNameLowerCase.includes(this.filterName.toLowerCase());

        let recipientBusinesName: string = model.destinationPerson.businessName;
        if(recipientBusinesName == null){
          recipientBusinesName = ''
        }
        const recipientBussnessNameLowerCase = recipientBusinesName.toLowerCase();
        resultRecipientBusinesName = recipientBussnessNameLowerCase.includes(this.filterName.toLowerCase());
